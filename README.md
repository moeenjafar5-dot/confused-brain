...
index 2c1b9e4ee145961275b20df550d190446a65e579..6ab801903bf6c6d477feb6ecf85e89af38ac43ea 100644
--- a/README.md
+++ b/README.md
@@ -1,4442 +1,70 @@
-<p align="center">
...
+Confused Brain Lite is a simple personal knowledge app for saving coding, Excel, BI, SQL, and dashboard concepts for quick revision. It is intentionally beginner-friendly: no Firebase setup, no database rules, no command-line deployment requirement, and no custom backend.
 
-<h4 align="center">A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools, and more.</h4>
+## What this version does
 
-<br>
+- Create, edit, delete, search, and favorite study notes.
+- Organize notes by practical categories like Coding, Excel, BI, SQL, and Power BI.
+- Save tags, key concepts, and real task examples.
+- Auto-save all data in the browser with `localStorage`.
+- Export a JSON backup and import it on another device.
+- Deploy as plain static files on Netlify, GitHub Pages, Firebase Hosting, or any basic web host.
...
-  </a>
-</p>
+## Important note about device sync
 
-<br>
+This Lite version is designed to be easy for a non-IT student to deploy. It does **not** use accounts, Firebase, or automatic real-time sync. To move notes between devices, use **Export backup** on one device and **Import backup** on another device.
 
-****
+If you later want automatic phone-to-PC sync, the app can be upgraded back to Firebase, Supabase, or another hosted database service.
 
-## :notebook_with_decorative_cover: &nbsp;What is it?
+## Easiest deployment option: Netlify drag-and-drop
 
-This repository is a collection of various materials and tools that I use every day in my work. It contains a lot of useful information gathered in one piece. It is an invaluable source of knowledge for me that I often look back on.
+1. Go to [Netlify Drop](https://app.netlify.com/drop).
+2. Drag this project folder into the browser window.
+3. Netlify will publish the app and give you a website link.
+4. Open the link on your phone or PC.
 
-## :restroom: &nbsp;For whom?
+No terminal commands are required for this option.
 
-For everyone, really. Here everyone can find their favourite tastes. But to be perfectly honest, it is aimed towards System and Network administrators, DevOps, Pentesters, and Security Researchers.
+## Other simple deployment options
...
-
-Example:
+If you want to preview the app on your computer before deploying, run:
...
+- `src/app.js` contains the notes logic.
+- `src/styles.css` contains the yellow responsive design.
+- `package.json` only provides optional preview/build helper commands.
